...
typedef struct _PVRSRV_MISC_INFO_
{
	...
	PVRSRV_EVENTOBJECT	sGlobalEventObject; /* 40 */
#if defined (SUPPORT_SID_INTERFACE)
	IMG_EVENTSID		hOSGlobalEvent; /* 96 */
#else
